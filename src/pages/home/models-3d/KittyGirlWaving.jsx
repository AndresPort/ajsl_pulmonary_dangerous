...
function KittyGirlWaving(props) {
  const group = useRef()
...
useEffect(() => {
  if (actions?.StandingGreetings) {
    actions.StandingGreetings.play();
    return () => {
      actions.StandingGreetings?.stop();
    };
  }
}, [actions?.StandingGreetings]);
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        <group name="KittyGirlArmature" rotation={[Math.PI / 2, 0, 0]} scale={0.01}>
          <skinnedMesh
            name="AboveHair"
...
export default KittyGirlWaving;
